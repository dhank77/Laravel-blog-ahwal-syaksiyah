                ...
                <div class="card-body">
                    <div class="general-label">
                        <form method="post" action="{{ route('pengajar.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 row">
                                <label for="nama" class="col-sm-2 form-label align-self-center mb-lg-0">Nama Lengkap</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama" id="nama"
                                        placeholder="nama" value="{{ $pengajar->nama }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="jabatan" id="jabatan"
                                        placeholder="jabatan" value="{{ $pengajar->jabatan }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="keahlian" class="col-sm-2 form-label align-self-center mb-lg-0">Keahlian</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="keahlian" id="keahlian"
                                        placeholder="keahlian" value="{{ $pengajar->keahlian }}">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="gambar"
                                ...
                                <div class="col-sm-10">
                                    <img id="preview-image-before-upload" src="{{ $pengajar->gambar != "" ? asset("storage/$pengajar->gambar") : asset('noimage.png') }}"
