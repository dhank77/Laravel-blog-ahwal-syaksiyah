        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title float-start">Daftar File Download</h4>
                    <div class="float-end">
                        <a class="btn btn-primary" href="{{ route('download.add') }}">+ Tambah</a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($download as $k => $a)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-primary" href="{{ asset("storage/$a->file") }}">Unduh</a>
                                    </td>
                                    <td>
